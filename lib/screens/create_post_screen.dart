...
class _CreatePostScreenState extends State<CreatePostScreen>
    ...
    if (pickedFiles.isNotEmpty) {
      ...
      if (pickedFiles.length > remainingSlots) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                '$remainingSlots resim eklendi. Maksimum $maxImages resim yükleyebilirsiniz.'),
  ...
  void _insertHashtag(String hashtag) {
    ...
    final cursorPos = _contentController.selection.baseOffset;
    final newText =
        '${text.substring(0, cursorPos)}$hashtag ${text.substring(cursorPos)}';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          _buildEditTab(context, textColor, cardColor, backgroundColor,
  ...
  Widget _buildEditTab(BuildContext context, Color textColor, Color cardColor,
      Color? backgroundColor, int characterCount, bool isOverLimit) {
    return Form(
      key: _formKey,
      child: Column(
        children: [
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                        'Düşüncelerini, deneyimlerini veya fotoğraflarını paylaş...',
                    hintStyle:
